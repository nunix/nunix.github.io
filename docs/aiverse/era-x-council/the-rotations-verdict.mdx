...
<Admonition type="info" title="⚙️ Update from the M137-M139 audit — read this table with the one above">
...
| Vendor | Recorded (M145) | Corrected | What changed |
|---|---|---|---|
| <Term id="haiku">Claude Haiku</Term> | 8 | 11 | absorbs the 3 mislabeled calls, run on Haiku all along |
| <Term id="gemini-3-5-flash">Gemini 3.5 Flash</Term> | 2 | 1 | 1 of 2 calls never actually reached Gemini |
| <Term id="gpt-5-6-terra">GPT-5.6 Terra</Term> | 4 | 2 | 2 of 4 calls never actually reached GPT-5.6 Terra |

...
| Chronicle | Delivered |
|---|---|
| I. The Wrong Hammer | Ollama/ROCm failure, Thai drift, 113s Q2, KDE crash |
| II. What the GTT Teaches | iGPU architecture, VRAM+GTT unified pool |
| III. The Vulkan Verdict | 5× speedup, clean passes, backend matters |

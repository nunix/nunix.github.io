...
- **`cache=none`** — O_DIRECT. Bypasses the host page cache entirely. Writes go to the NVMe controller, not a <Term id="kernel">kernel</Term> buffer. Safe, and correct for SSD-backed VMs.

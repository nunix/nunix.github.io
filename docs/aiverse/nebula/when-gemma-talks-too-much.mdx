...
Google shipped gemma4:12B on June 3, 2026. The model — encoder-free, natively multimodal, 256K context — looked promising as a <Term id="warp">Warp</Term> brain upgrade. The fleet had qwen2.5:14b at 13.5 tok/s with stable tool calling. Gemma4 promised more.

The first obstacle: <Term id="ollama">Ollama</Term> 0.24.0 didn't know gemma4 existed. Upgrade to 0.30.4.

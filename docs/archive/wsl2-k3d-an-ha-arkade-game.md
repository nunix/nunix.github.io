...
![image-20200505130857772](assets/wsl2-k3d-docker-check-version.png)
...
![image-20200505131322450](assets/wsl2-k3d-install.png)
...
![image-20200505134643494](assets/wsl2-k3d-cluster-single-node.png)
...
![image-20200505135333736](assets/wsl2-k3d-cluster-delete-single-node.png)
...
![](assets/wsl2-k3d-cluster-multi-node.png)
...
![image-20200505165602275](assets/wsl2-arkade-install.png)
...
![image-20200505165912083](assets/wsl2-arkade-apps-install-options.png)
...
![](assets/wsl2-portainer-nodeport.png)
...
![image-20200511173423156](assets/wsl2-portainer-loadbalancer-ingress.png)

Once created, open your Windows browser and enter the url http://\<master IP\>:\<Ingress port\>

![image-20200511173630724](assets/wsl2-portainer-loadbalancer-ingress-browser.png)
...
![image-20200511174303124](assets/wsl2-k3d-cluster-defense-status.png)
...
![image-20200511175504433](assets/wsl2-k3d-cluster-defense-post-status.png)

...
![](assets/docker-settings-switch-win-containers.png)

![](assets/docker-settings-switch-win-containers-confirm.png)
...
![](assets/docker-windows-named-pipe.png)

3. Once done, switch back to Linux containers, it will be needed for the WSL2 node

![](assets/docker-settings-switch-linux-containers.png)

![](assets/docker-settings-switch-linux-containers-confirm.png)
...
![](assets/docker-swarm-workers-join.png)
...
![](assets/wsl2-docker-settings-enable-distro.png)
...
![](assets/wsl2-docker-check-version.png)
...
![](assets/multipass-check-driver.png)
...
![](assets/multipass-check-install.png)
...
![](assets/vagrant-up-hyperv.png) ![](assets/vagrant-up-hyperv-username.png)
...
![](assets/portainer-create-container.png)
...
![](assets/portainer-first-run.png)

Set a password for the admin account and you're in

![](assets/portainer-first-login.png)
...
![](assets/portainer-local-connection.png)

2. Click on the endpoint `local`

![](assets/portainer-local-endpoint.png)

3. On the left menu, click on the `swarm` option

![](assets/portainer-swarm-menu.png)
...
![](assets/docker-swarm-get-files.png)
...
![](assets/docker-swarm-dockerfile-edit.png)
...
![](assets/docker-swarm-build-image.png)
...
![](assets/docker-swarm-check-image.png)
...
![](assets/docker-swarm-push-image.png)
...
![](assets/docker-swarm-edit-compose.png)
...
![](assets/docker-swarm-stack-deploy.png)
...
![](assets/docker-swarm-scale-services.png)

Check also in Portainer what is displayed

![](assets/portainer-check-scaled-services.png)

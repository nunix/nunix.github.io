...
![Custom distro install](assets/wsl2inits-custom-distro-install.png)
...
![Gentoo update](assets/wsl2inits-gentoo-update.png)
...
![Install Docker](assets/wsl2inits-gentoo-install-docker.png)
...
![Install Docker service](assets/wsl2inits-gentoo-install-docker-service.png)
...
![Install Arkade, K3sup and Kubectl](assets/wsl2inits-gentoo-install-arkade.png)
...
![Install K3s cluster](assets/wsl2inits-gentoo-install-k3s.png)
...
image: https://images.credly.com/size/340x340assets/images/8005660c-ff3b-40d3-8546-c6dd668be4ab/image.png
tags:
  - wsl2
  - cilium
  - isovalent
...
![Create the modules-load.d file](assets/wsl2-cilium-kernel-create-modules-file.png)
...
![Edit the systemd-modules-load service](assets/wsl2-cilium-kernel-edit-systemd-modules-load-service.png)
...
![Check the modules loaded](assets/wsl2-cilium-kernel-modules-loaded.png)
...
![Lab: Copy the KinD configuration](assets/wsl2-cilium-lab-kind-config.png)

![WSL: Save the KinD configuration](assets/wsl2-cilium-kind-config.png)
...
![Lab: List the KinD nodes](assets/wsl2-cilium-lab-kind-nodes.png)
...
![Install Cilium](assets/wsl2-cilium-install.png)
...
![Check the status of Cilium](assets/wsl2-cilium-status.png)
...
![Deploy the Star Wars application](assets/wsl2-cilium-deploy-microservices.png)
...
![Request access from the two pods](assets/wsl2-cilium-application-request-access-no-policies.png)
...
![Apply the Cilium Network Policy](assets/wsl2-cilium-application-request-access-l3l4-policy.png)
...
![Destroy the Deathstar from a Tiefighter pod](assets/wsl2-cilium-application-destroy-no-policies.png)
...
![Destroy the Deathstar from a Tiefighter pod](assets/wsl2-cilium-application-destroy-l7-policies.png)
...
![Install k3d](assets/wsl2-cilium-install-k3d.png)
...
![Create a k3d cluster](assets/wsl2-cilium-k3d-create-cluster.png)
...
![Check the cluster with k3d and kubectl](assets/wsl2-cilium-k3d-check-cluster.png)
...
![Create a k3d cluster from a config file](assets/wsl2-cilium-k3d-create-cluster-configfile.png)
...
![Mount the BPF filesystem](assets/wsl2-cilium-k3d-mount-bpf.png)
...
![Install Cilium](assets/wsl2-cilium-k3d-install.png)
...
![Monitor the pods after the Cilium installation started](assets/wsl2-cilium-k3d-monitor-pods-after-install.png)
...
![Change the cgroupv2 mount to a shared mount](assets/wsl2-cilium-k3d-mount-cgroupv2.png)
...
![List the pods after Cilium install finished](assets/wsl2-cilium-k3d-monitor-pods-after-cgroupv2-mount.png)

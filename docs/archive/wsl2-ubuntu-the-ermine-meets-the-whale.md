...
![First update](assets/wsl-ermine-update.png)

![Adding a user and the SystemD required packages](assets/wsl-ermine-packages.png)

![Configuring SystemD](assets/wsl-ermine-system-config.png)

![Restart the WSL2 distro](assets/wsl-ermine-restart.png)
...
![Downloading Docker and Containerd binaries](assets/wsl-ermine-docker-containerd-download.png)

![Downloading the Docker SystemD files](assets/wsl-ermine-docker-systemd-download.png)

![Extracting Docker and Containerd binaries to /usr/bin](assets/wsl-ermine-docker-containerd-extract.png)

![Starting the Docker SystemD services](assets/wsl-ermine-docker-systemd-configure.png)
...
![Adding addons and saving configuration](assets/wsl-ermine-k8s-addons.png)
...
![Adding Microk8s endpoint to Docker context](assets/wsl-ermine-k8s-endpoint.png)

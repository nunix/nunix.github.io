...
![](assets/winget-docker-search.png)
...
![](assets/docker-run-getting-started.png)
...
![](assets/docker-context-list.png)
...
![](assets/docker-login-azure.png)

![](assets/docker-login-azure-success.png)
...
![](assets/docker-login-azure-error.png)
...
![](assets/docker-context-create.png)
...
![](assets/docker-context-use-aci.png)
...
![](assets/docker-run-getting-started-aci.png)
...
![](assets/azure-aci-container-list.png)
...
![](assets/docker-rm-getting-started-aci.png)

* And, as before, we can check in the Azure Portal if the container is no more listed

![](assets/azure-aci-container-list-refresh.png)
...
![](assets/docker-compose-repository-clone.png)
...
![](assets/docker-compose-file-open.png)

![](assets/docker-compose-file-edit.png)
...
![](assets/docker-compose-up-local.png)

![](assets/docker-compose-up-local-success.png)
...
![](assets/docker-compose-image-push.png)
...
![](assets/docker-compose-file-aci.png)
...
![](assets/docker-compose-up-aci.png)
...
![](assets/azure-aci-compose-container-list.png)
...
![](assets/docker-compose-aci-down.png)
...
![](assets/az-file-share-create.png)
...
![](assets/az-file-list-pre-container.png)
...
![](assets/docker-volume-container-create.png)

- Create a file from the container application

![](assets/docker-volume-create-file.png)
...
![](assets/az-file-list-post-container.png)
...
![](assets/az-file-check-content.png)

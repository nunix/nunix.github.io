...
![Pull the RHEL8 GO image](assets/docker-pull-rhel-image.png)
...
![Export the container to a file](assets/docker-container-export.png)
...
![Create a new WSL distro](assets/wsl2-import-rhel8.png)
...
![Register the system](assets/rhel-register-system.png)
...
![Check the system registration in Customer Portal](assets/rhel-register-system-check-portal.png)
...
![Update the system](assets/rhel-update-system.png)
...
![Add zsh, sudo and cracklibs-dict packages](assets/rhel-add-sudo-zsh.png)
...
![Create a new user](assets/rhel-create-user.png)
...
![Create the config file wsl.conf](assets/rhel-create-wsl-conf.png)
...
![Terminate the distro](assets/wsl2-terminate-distro.png)
...
![Check the user and sudo](assets/rhel-user-login.png)
...
![Install oh my zsh](assets/rhel-install-oh-my-zsh.png)
...
![Change oh my zsh theme](assets/rhel-zsh-theme.png)
...
![Update the oh my zsh theme](assets/rhel-zsh-theme-change.png)
...
![Add the boot command to the WSL configuration file](assets/rhel-boot-command.png)
...
![Create SystemD init script](assets/rhel-systemd-script.png)
...
![Update sudoers](assets/rhel-systemd-sudoers.png)
...
![Check if the SystemD processes are running](assets/rhel-systemd-check.png)
...
![Add the yum-utils package](assets/rhel-add-yum-utils.png)
...
![Add the Docker repository](assets/rhel-add-docker-repo.png)
...
![Install Docker](assets/rhel-install-docker.png)
...
![Start Docker](assets/rhel-start-docker.png)
...
![Add the user to Docker group](assets/rhel-add-docker-group.png)

...
![Test WolfiOS in a container](assets/wsl2-wolfios-test-container.png)
...
![Create WolfiOS WSL2 distro](assets/wsl2-wolfios-create-distro.png)
...
![Disable the FSTAB automount](assets/wsl2-wolfios-customization-fstab.png)
...
![VS Code launch fails](assets/wsl2-wolfios-vscode-launch-error.png)
...
![VS Code server install](assets/wsl2-wolfios-vscode-server-install.png)
...
![Add required packages](assets/wsl2-wolfios-rust-add-packages.png)
...
![Install the Rust coreutils](assets/wsl2-wolfios-rust-install-packages.png)

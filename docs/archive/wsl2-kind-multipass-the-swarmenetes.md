...
![WSL2 KinD install](assets/wsl-kind-install.png)
...
![image-20201111085726859](assets/wsl-kubectl-install.png)
...
![WSL2 kubeadm dependencies install](assets/wsl-kubeadm-dependencies.png)
...
![WSL2 kubeadm repository add](assets/wsl-kubeadm-repository-add.png)
...
![WSL2 kubeadm repository refresh](assets/wsl-kubeadm-repository-refresh.png)
...
![WSL2 kubeadm install](assets/wsl-kubeadm-install.png)
...
![image-20201111152038754](assets/wsl-kubeadm-version.png)
...
![Multipass create new VM](assets/multipass-create-vm.png)
...
![Multipass enter into VM shell](assets/multipass-shell-vm.png)
...
![Multipass guest OS update](assets/multipass-os-update.png)

![Multipass guest OS update part 2](assets/multipass-os-update-2.png)
...
![Multipass guest OS upgrade](assets/multipass-os-upgrade.png)

![Multipass guest OS part 2](assets/multipass-os-upgrade-2.png)
...
![Multipass Docker dependencies install](assets/multipass-docker-dependencies-install.png)
...
![Multipass Docker repository install](assets/multipass-docker-repository-install.png)
...
![Multipass Docker install](assets/multipass-docker-install.png)
...
![Multipass Docker add user to group](assets/multipass-docker-group-add-user.png)
...
![Multipass Docker status](assets/multipass-docker-status.png)
...
![Multipass Kind install](assets/multipass-kind-install.png)
...
![Multipass Kubernetes tools install](assets/multipass-k8s-tools-install.png)
...
![Multipass VM info](assets/multipass-vm-info.png)
...
![WSL2 ping Hyper-V](assets/wsl2-hyperv-ping.png)
...
![WSL2 ping Hyper-VM VM successfully](assets/wsl2-hyperv-network-forward.png)
...
![image-20201115134453998](assets/wsl2-hyperv-ping-success.png)
...
![WSL2 Docker Swarm init](assets/wsl2-docker-swarm-init.png)
...
![Multipass VM docker join](assets/wsl2-docker-swarm-join.png)
...
![WSL2 Swarm nodes list](assets/wsl2-docker-swarm-node-list.png)
...
![WSL2 Swarm network create](assets/wsl2-docker-swarm-network-create.png)
...
![image-20201115212419227](assets/multipass-docker-swarm-network-check.png)
...
![WSL2 KinD create cluster](assets/wsl2-kind-cluster-create.png)
...
![image-20201115175211288](assets/wsl2-kind-cluster-check.png)
...
![KinD create join token](assets/wsl2-kind-cluster-join-token.png)
...
![Docker KinD control plane port bindings](assets/wsl2-kind-cluster-port-check.png)
...
![Docker KinD check server connection string](assets/wsl2-kind-cluster-config-internal.png)
...
![image-20201116152850007](assets/wsl2-kind-cluster-join-token-internal.png)
...
![KinD network variable set](assets/wsl2-kind-cluster-network-variable.png)
...
![KinD cluster multi-nodes create on first node](assets/wsl2-kind-cluster-create-multinode.png)
...
![KinD cluster multi-nodes create on second node](assets/multipass-kind-cluster-create-multinode.png)
...
![KinD cluster multi-nodes check](assets/wsl2-kind-cluster-multinode-check.png)
...
![image-20201116160213846](assets/multipass-kind-cluster-multinode-check.png)
...
![Docker curl second node](assets/wsl2-kind-cluster-network-curl.png)
...
![Docker KinD get DNS name and IP](assets/wsl2-kind-cluster-hostname-ip.png)
...
![image-20201116162950619](assets/multipass-kind-cluster-reset.png)
...
![Docker KinD generate join command](assets/wsl2-kind-cluster-join-token-internal-multinode.png)
...
![KinD second node join](assets/multipass-kind-cluster-join-multinode.png)

![KinD second node join](assets/multipass-kind-cluster-join-multinode-2.png)
...
![image-20201116172530878](assets/wsl2-kind-cluster-multinode-check-complete.png)
...
![image-20201116173400930](assets/wsl2-kind-cluster-pods-check.png)

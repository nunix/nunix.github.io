...
>
> ![Re-install Incus after enabling systemd](assets/wsl2-blincus-incus-install-error-fix.png)

![Add Incus repo](assets/wsl2-blincus-incus-repo-install.png)
...
![Install Blincus](assets/wsl2-blincus-install.png)
...
![Add Blincus bin directory to the PATH variable](assets/wsl2-blincus-path.png)
...
![Launch Blincus first instance](assets/wsl2-blincus-first-instance.png)
...
![Comment the gecos field](assets/wsl2-blincus-gecos-field.png)

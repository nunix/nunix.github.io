...
export const AIVERSE_ERAS: AiverseEra[] = [
  ...
  {
    id: 'era-xi',
    label: 'Era XI — Imperium Lost Worlds',
    tagline: 'Nothing was destroyed. It was just no longer visited.',
    missions: 'M37, M50, M162–',
    color: '#8b5cf6',
    ...
    postStartAngle: -Math.PI / 2,
    postOrbitDirection: -1,
    // Scroll / archive icon — old records rediscovered
    ...
    posts: [
      {
        ...
        subtitle: 'A table that forgot the audits older than itself',

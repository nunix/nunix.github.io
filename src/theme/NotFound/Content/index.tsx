...
// Directly import the JSON data from your static folder
// Ensure 'static/ssl-info.json' exists, or the build might fail.
import sslData from '@site/static/ssl-info.json';

export default function NotFound() {
  const { siteConfig } = useDocusaurusContext();
  
  // Extract the gitDate. Fallback to a placeholder if the key is missing.
  const kernelVersion = sslData.last_updated || 'LEGACY_BUILD';
      ...
      <div className="panic-container">
        ...
        <div className="panic-content">
          ...
          <div className="panic-footer">
            NUNIX_OS // KERNEL v{kernelVersion} // HALT CODE: 0x00000404
          </div>
        </div>
      </div>
    </>
